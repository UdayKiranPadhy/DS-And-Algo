...
You have n ice cream base flavors and m types of toppings to choose from. You must 
...
Output: 10
Explanation: Notice that you don't have to have any toppings, but 
you must have exactly one base.
