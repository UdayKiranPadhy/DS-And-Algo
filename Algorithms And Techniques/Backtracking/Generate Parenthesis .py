...
# bracket and a opening bracket , if we can then place it and increase the length of the string
# and run it till it becomes 2*n length string.

# In order to tell weather we can place a bracket we can use logic of minimum swaps required to make
# balanced brackets (array)
