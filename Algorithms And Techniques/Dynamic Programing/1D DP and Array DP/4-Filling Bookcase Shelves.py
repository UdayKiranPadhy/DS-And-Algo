...
books[i] = [thicknessi, heighti] indicates the thickness and height of the ith book.
...
is less than or equal to shelfWidth, then build another level of the shelf of the bookcase so
...
book onto the first shelf, the third book on the second shelf, and the fourth and fifth book on the last shelf.
